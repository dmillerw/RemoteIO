...
public interface IWailaDataProvider{
	 ...
	 * Will be used if the implementing class is registered via {@link mcp.mobius.waila.api.IWailaRegistrar}.{@link registerStackProvider}.</br>
	 ...
	 * Will be used if the implementing class is registered via {@link mcp.mobius.waila.api.IWailaRegistrar}.{@link registerNBTProvider} server and client side.</br>
